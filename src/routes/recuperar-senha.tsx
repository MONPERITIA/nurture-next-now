...
export const Route = createFileRoute("/recuperar-senha")({
  head: () => ({
    meta: [
      { title: "Recuperar senha — MONPERIT IA" },
      {
        name: "description",
        content: "Recuperação de senha na plataforma MONPERIT IA.",
      },
      { property: "og:title", content: "Recuperar senha — MONPERIT IA" },
      { property: "og:description", content: "Recuperação de senha na plataforma MONPERIT IA." },
    ],
  }),
  component: RecuperarSenhaRoute,
});
    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-5 py-10">
      <div className="w-full max-w-sm">
        ...
        <p className="text-sm text-pergaminho-300 text-center mb-6">
          Informe o e-mail cadastrado para receber um link ou código de recuperação.
        </p>
